...
class NotificationsWindow(QWidget, Ui_NotificationsForm):
    ...
    def show_notification(self, t, d):
        if self.notification_on:
            ...
            tray_icon.setIcon(QIcon("icon2_menu.png"))
            tray_icon.setVisible(True)
            tray_icon.showMessage(t, d, QSystemTrayIcon.MessageIcon.Information, 5000)
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.balance = int(open("config.txt").read().split()[3])
